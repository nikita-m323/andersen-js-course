...
console.log(any([0, 1, 4, 0], x => x >= 2));
console.log(any([0, 1, 0, 0], x => x >= 2));
console.log(any([0, 1, 4, 0]));
console.log(any([0, 0, 0, 0]));

console.log('=============');

console.log(arrayDiff([1, 'calf', 3, 'piglet'], [1, 'calf', 3, 4, 4, 5, 5]));
console.log(arrayDiff([1, 2, 3], [1, 2, 4]));
console.log(arrayDiff([1, 3, 3, 4], [1, 3, '4', 5]))
...
console.log(transformArrayToNumber([10, 20, 30], (acc, item) => acc + item, 20));
console.log(transformArrayToNumber([10, 20, 30], (acc, item) => acc * item));
...
console.log(without([2, 1, 10, 20], 1, 2, 1, 2));
